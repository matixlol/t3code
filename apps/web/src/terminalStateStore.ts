...
export function selectThreadTerminalState(
  ...
  return normalizeThreadTerminalState(
    terminalStateByThreadKey[terminalThreadKey(threadRef)] ?? getDefaultThreadTerminalState(),
  );
}
...
interface TerminalStateStoreState {
  ...
  openPreview: (threadRef: ScopedThreadRef, url: string) => void;
  closePreview: (threadRef: ScopedThreadRef) => void;
  ...
  persist(
    (set) => {
      ...
      return {
        ...
        openPreview: (threadRef, url) =>
          updateTerminal(threadRef, (state) => openThreadPreview(state, url)),
        closePreview: (threadRef) =>
          updateTerminal(threadRef, (state) => closeThreadPreview(state)),
